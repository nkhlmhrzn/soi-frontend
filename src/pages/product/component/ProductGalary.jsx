...
const [active,setactive] = useState(img[0])
    return ( 
        <>
            <div className="flex-1 flex-col gap-4 bg-gray-200 p-6">
                ...
                <div className="flex gap-4 p-4 ">
                        {img.map((imgs)=>{
                            return (
                                <div className={`h-20 w-20 rounded-md overflow-hidden   border-2  ${active.id===imgs.id ? "border-blue-600":"opacity-50"}
                                    hover:scale-110 trasition duration-300`} onClick={()=>{setactive(imgs)}}>
